          ...
          onPressed: () async {
            if (mode == PromptMode.submit) {
              final String? text = await showModalBottomSheet<String>(
                ...
                builder:
                    (context) => SubmitAnswerPage(bubbleId: widget.bubbleId),
              );
              if (text != null) {
                final API api = context.read<API>();
              ...
              final String? text = await showModalBottomSheet<String>(
                ...
                builder:
                    (context) => SubmitPromptPage(bubbleId: widget.bubbleId),
              );
              if (text != null) {
                final API api = context.read<API>();
              ...
              try {
                ...
                context.showErrorSnackbar("Something went horribly wrong :/");
                return;
              }
