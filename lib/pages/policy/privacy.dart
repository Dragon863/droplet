...
class PrivacyPolicyPage extends StatelessWidget {
  ...
  void _copyToClipboard(BuildContext context, String text) {
    ...
    context.showSuccessSnackbar('Email address copied to clipboard');
  }
        ...
        child: Center(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  'Privacy Policy for Droplet App',
                ...
                const Text(
                  'Welcome to the Droplet App, designed to provide a simple way to share ideas with your friends. In the Droplet team, your privacy is of paramount importance to us. This Privacy Policy outlines the types of information we collect, how we use it, and the steps we take to ensure your data is handled securely.',
                ...
                const Text(
                  ...
                  '• Profile Picture: Optional, but if provided, it will be displayed to your friends within the app.\n'
                  '• Push Notification Token: Used to send notifications through OneSignal, a GDPR-compliant service.\n'
                  '• User ID: A unique identifier assigned to your account, used for internal purposes and to manage your account.\n'
